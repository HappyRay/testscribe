...
from test_scribe.api.alias import g_aliases
from test_scribe.complex_value_util import generic_is_special_type
...
from test_scribe.type_util import get_class_type, get_type_origin, get_type_args
from test_scribe.value_input_util import is_simple_value, import_modules_from_expression
...
def eval_with_injected_names(expression: str) -> Any:
    ...
    global_dict["m"] = test_scribe.api.mock_api.m
...
def is_mock_marker(value) -> bool:
    return value is test_scribe.api.mock_api.m
