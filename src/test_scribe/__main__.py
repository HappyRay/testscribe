...
from test_scribe.create_test_cmd import create_test
from test_scribe.delete_test_cmd import delete_test
from test_scribe.exception_decorator import exception_handler
from test_scribe.move_cmd import move_tests
from test_scribe.sync_cmd import regenerate_tests, regenerate_all_tests
from test_scribe.update_test_cmd import update_test_cmd

app = typer.Typer(name="test_scribe")
...
def delete(
    scribe_file_path: Path = Argument(
        ...,
        help="The test_scribe file to modify",
        exists=True,
        file_okay=True,
        dir_okay=False,
        writable=True,
    ...
    """
    Delete a test. This will delete the test from both the test_scribe file
...
def sync(
    scribe_file_path: Path = Argument(
        ...,
        help="The test_scribe file to sync",
        exists=True,
        file_okay=True,
        dir_okay=False,
        writable=True,
...
def update(
    scribe_file_path: Path = Argument(
        ...,
        help="The test_scribe file to update",
        exists=True,
        file_okay=True,
        dir_okay=False,
        writable=True,
