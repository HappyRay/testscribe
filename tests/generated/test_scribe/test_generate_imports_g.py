...
from test_scribe.generate_imports import gather_import_statement_for_exception_support, gather_import_statement_for_patch_support, gather_import_statements_for_mock_support, gather_import_statements_for_test_targets, generate_import_statement_str, get_target_for_a_test, need_exception_support, need_mock_support
...
def test_gather_import_statements_for_exception_support_has_exception():
    ...
    m_exception_model: test_scribe.model_type.ExceptionModel = create_autospec(spec=test_scribe.model_type.ExceptionModel)
...
def test_gather_import_statements_for_mock_support_has_mock():
    ...
    assert result == ['from test_scribe.api.mock_api import get_normalized_mock_calls', 'from unittest.mock import ANY, call, create_autospec']
    m_test_model.assert_not_called()
