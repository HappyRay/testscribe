...
def test_get_previous_call_count():
    m_mock_call: test_scribe.mock_call.MockCall = create_autospec(spec=test_scribe.mock_call.MockCall)
    m_mock_call_1: test_scribe.mock_call.MockCall = create_autospec(spec=test_scribe.mock_call.MockCall)
    m_mock_call_2: test_scribe.mock_call.MockCall = create_autospec(spec=test_scribe.mock_call.MockCall)
