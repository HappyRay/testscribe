import pathlib
import setup
import test_scribe.cli
import test_scribe.error
import pytest
from test_scribe.config import get_output_root_path, get_setup_func, initialize_io, load_config_data
...
def test_initialize_io_default():
    ...
    assert isinstance(result, test_scribe.cli.CLI)
