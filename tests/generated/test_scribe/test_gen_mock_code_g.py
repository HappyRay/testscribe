...
from test_scribe.gen_mock_code import create_call_dict_indexed_by_method_name, gen_mock_return_values_for_one_method_with_return_values, generate_behavior_statements_for_one_mock, generate_mock_behavior_statements, generate_mock_return_values, generate_one_mock_creation_statement, generate_property_init_statements, get_full_mock_method_name, has_not_ignored_return_value, is_single_real_return_value


def test_create_call_dict_indexed_by_method_name():
    input_mock: test_scribe.model.MockCallModel = create_autospec(spec=test_scribe.model.MockCallModel)
    input_mock_1: test_scribe.model.MockCallModel = create_autospec(spec=test_scribe.model.MockCallModel)
    input_mock_2: test_scribe.model.MockCallModel = create_autospec(spec=test_scribe.model.MockCallModel)
    input_mock.name = 'a'
    input_mock_1.name = 'b'
    input_mock_2.name = 'a'
...
def test_gen_mock_return_values_for_one_method_with_return_values_single_user_triggered_exception():
    result = gen_mock_return_values_for_one_method_with_return_values(mock_object_name='m', method_name='', return_values=[test_scribe.user_triggered_exception.UserTriggeredException(Exception())])
...
def test_gen_mock_return_values_for_one_method_with_return_values_only_ignored():
    result = gen_mock_return_values_for_one_method_with_return_values(mock_object_name='m', method_name='foo', return_values=[test_scribe.ignore.IGNORED])
    assert result == ''
...
def test_generate_behavior_statements_for_one_mock():
    mock: test_scribe.model_type.MockModel = create_autospec(spec=test_scribe.model_type.MockModel)
...
def test_generate_mock_return_values_one_method_different_return_values():
    mock: test_scribe.model_type.MockModel = create_autospec(spec=test_scribe.model_type.MockModel)
    input_mock: test_scribe.model_type.MockCallModel = create_autospec(spec=test_scribe.model_type.MockCallModel)
    input_mock_1: test_scribe.model_type.MockCallModel = create_autospec(spec=test_scribe.model_type.MockCallModel)
...
def test_has_not_ignored_return_value_has_exception():
    result = has_not_ignored_return_value(values=[test_scribe.user_triggered_exception.UserTriggeredException(Exception())])
    assert result is True


def test_has_not_ignored_return_value_only_ignored():
    result = has_not_ignored_return_value(values=[test_scribe.ignore.IGNORED, test_scribe.ignore.IGNORED])
    assert result is False


def test_has_not_ignored_return_value_has_real_value():
    result = has_not_ignored_return_value(values=[1, test_scribe.ignore.IGNORED])
    assert result is True


def test_is_single_real_return_value_only_ignored():
    result = is_single_real_return_value(return_values=[test_scribe.ignore.IGNORED])
    assert result is False


def test_is_single_real_return_value_only_user_triggered_exception():
    result = is_single_real_return_value(return_values=[test_scribe.user_triggered_exception.UserTriggeredException(Exception())])
    assert result is False
