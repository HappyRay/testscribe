...
from test_scribe.namedvalues import NamedValues, format_one_param
...
def test_as_list():
    instance = NamedValues(name_value_list=test_scribe.namedvalues.NamedValues([('a', 1)]))
...
def test_get_value_by_name_not_found():
    ...
    assert result == test_scribe.namedvalues.NameNotFound
