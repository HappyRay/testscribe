...
from testscribe.complex_value_util import contain_complex_value, generic_is_special_type, has_custom_repr_method, has_unstable_repr, is_complex_value, is_enumerable_type, object_contains_unstable_repr
...
def test_is_complex_value_module_model():
    result = is_complex_value(value=testscribe.model_type.ModuleModel("foo"))
    assert result is True
