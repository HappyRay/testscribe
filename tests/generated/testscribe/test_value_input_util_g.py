...
def test_transform_default_value_no_default():
    result = transform_default_value(default=testscribe.special_type.NoDefault, t=str)
    assert result == ''
...
def test_transform_mock_names_to_mock_expression_mock_name_in_a_tuple():
    ...
    result = transform_mock_names_to_mock_expression(v=(1, testscribe.model_type.MockNameModel("m1_2")), test_to_infer_default_inputs=m_test_model)
...
def test_transform_mock_names_to_mock_expression_simple_mock_name():
    ...
    m_mock_model.name = 'm1_2'
    m_mock_model.spec_str = 'spec'
    result = transform_mock_names_to_mock_expression(v=testscribe.model_type.MockNameModel("m1_2"), test_to_infer_default_inputs=m_test_model)
...
def test_transform_real_default_value_expression():
    result = transform_real_default_value(default=testscribe.model_type.ExpressionModel("e"))
    assert result == 'e'


def test_transform_real_default_value_set():
    result = transform_real_default_value(default=testscribe.model_type.SetModel([1, 2]))
