...
from testscribe.model_type import AllTests, add_test, build_name_to_index_dict, delete_test_by_name, get_mock_by_name, get_type_str, sort_tests, update_test
...
def test_get_test_index_by_name():
    input_mock: testscribe.model_type.TestModel = create_autospec(spec=testscribe.model_type.TestModel)
    input_mock_1: testscribe.model_type.TestModel = create_autospec(spec=testscribe.model_type.TestModel)
...
def test_get_type_str_callable_model():
    result = get_type_str(v=testscribe.model_type.CallableModel("foo", "call_mod"))
